...
// #[test_case(b"  {%- if yes -%}  X  {%- end -%}" => "X"; "stmt_trim_left_right")]
// #[test_case(b"prefix text {%= str =%} suffix text\nnext line\n" => "foobar\nnext line\n"; "interp_eq_right_eats_newline")]
// #[test_case(b"# this is a comment {%= if yes =%}\nhello\n# this is a comment {%= end =%}\n" => "hello"; "stmt_eq_with_comment_barriers")]
